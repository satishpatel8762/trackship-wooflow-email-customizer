...
$additional_content = ( isset( $additional_content ) && ! empty( $additional_content ) ) ? $additional_content : sprintf( esc_html__( 'Thanks for reading.', 'wooflow-email-customizer' ) );
?>
